      ...
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-[#715482] mb-4">🎯 Personalized Recommendations</h4>
              <div className="space-y-3">
                {[
                  ...
                  <div key={index} className="p-3 bg-gray-50 rounded-lg border-l-4 border-[#715482]">
            ...
            <div>
              <h4 className="font-semibold text-[#715482] mb-4">⚡ Live Activity Feed</h4>
                  ...
                  <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-2">
                      <div className={`w-2 h-2 rounded-full ${
                        ...
                        activity.type === 'primary' ? 'bg-[#715482]' : 'bg-blue-500'
                      }`}></div>
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-[#715482] to-[#8B6794] rounded-xl text-white">
