      ...
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-[#6B4F4E] mb-3">Text to Convert</h4>
              <textarea
                placeholder="Paste your article text here or try our sample..."
                className="w-full h-32 p-4 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[#6B4F4E] focus:border-transparent resize-none"
              ...
              <div className="mt-4 space-y-3">
                <div>
                  ...
                  <select className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#6B4F4E]">
                ...
                <button className="w-full bg-[#6B4F4E] text-white py-3 rounded-xl font-medium hover:opacity-90 transition">
                  Generate Audio
                </button>
              </div>
            </div>
            ...
            <div>
              <h4 className="font-semibold text-[#6B4F4E] mb-3">Audio Player</h4>
              <div className="bg-gray-100 rounded-xl p-6">
                ...
                <div className="flex items-center justify-center mb-4">
                  <button className="bg-[#6B4F4E] text-white p-4 rounded-full hover:opacity-90 transition shadow-lg">
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full bg-gray-300 rounded-full h-2">
                    <div className="bg-[#6B4F4E] h-2 rounded-full transition-all duration-300" style={{width: '20%'}}></div>
                  </div>
                </div>

                <div className="flex justify-center space-x-4 mt-4">
                  <button className="text-[#6B4F4E] hover:opacity-70 transition">
