          ...
          <div className="mb-6">
            <div className="relative">
              <input
                ...
                className="w-full p-4 pl-12 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[#715482] focus:border-transparent text-lg"
              />
            ...
            <button className="w-full mt-4 bg-[#715482] text-white py-3 rounded-xl font-medium hover:opacity-90 transition text-lg">
              Search with AI
            </button>
          </div>

          <div className="space-y-4">
            <h4 className="font-semibold text-[#715482] text-lg">Search Results</h4>
            {[
              ...
              <div key={index} className="p-4 bg-gray-50 rounded-lg border-l-4 border-[#715482] hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start mb-2">
                  <h5 className="font-medium text-[#715482] text-lg">{result.title}</h5>
                ...
                <button className="mt-2 text-[#715482] text-sm hover:underline">Read Article →</button>
              </div>
            ))}
          </div>
        </div>
