  ...
  return (
    <section className="bg-[#F4EFEB] py-20 px-6">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <h2 className="text-4xl md:text-5xl font-bold text-[#715482] text-center mb-16 leading-tight max-w-4xl mx-auto">
          The Comprehensive AI Platform for Modern Publishers
        </h2>

        {/* Cards Container */}
        <div className="bg-[#715482] rounded-3xl p-6 md:p-8">
          {/* Desktop Grid Layout */}
          <div className="hidden md:grid grid-cols-3 gap-4 mb-6">
            ...
            {features.slice(0, 3).map((feature, index) => (
              ...
              >
                <h3 className="text-2xl font-bold text-[#715482] mb-2">
                  {feature.title}
                </h3>
                <p className="text-[#715482] leading-relaxed text-base">
                  {feature.description}
                </p>
              </div>
            ))}
