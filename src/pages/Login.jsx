  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-[#6B4F4E]/20 to-purple-400/20 rounded-full blur-3xl animate-pulse"></div>
        ...
        {/* Floating particles */}
        <div className="absolute top-20 right-1/4 w-2 h-2 bg-[#6B4F4E]/30 rounded-full animate-float"></div>
      ...
      <div className="max-w-md w-full space-y-8 relative z-10 animate-fade-in-up">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-medium flex items-center justify-center gap-2">
            <Shield size={16} className="text-[#6B4F4E]" />
          ...
          {/* <div className="flex items-center justify-center gap-6 mt-4 text-xs text-gray-500">
            ...
            <div className="flex items-center gap-1">
              <Zap size={12} className="text-[#6B4F4E]" />
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/50 p-8 transition-all duration-500 hover:shadow-3xl hover:bg-white/90 animate-slide-up relative">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 border-2 border-gray-200 rounded-xl text-gray-700 bg-white hover:bg-gray-50 hover:border-[#6B4F4E]/30 hover:shadow-md transition-all duration-300 font-medium group relative overflow-hidden"
          >
          ...
          <form className="mt-7 space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-2 group">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#6B4F4E]/20 focus:border-[#6B4F4E] outline-none transition-all duration-300 text-gray-900 placeholder-gray-400 hover:border-gray-300 bg-gray-50/50 focus:bg-white"
            ...
            <div className="space-y-2 group">
              <label htmlFor="password" className="block text-sm font-semibold text-gray-700 group-focus-within:text-[#6B4F4E] transition-colors duration-200">
                Password
              </label>
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3.5 pr-12 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#6B4F4E]/20 focus:border-[#6B4F4E] outline-none transition-all duration-300 text-gray-900 placeholder-gray-400 hover:border-gray-300 bg-gray-50/50 focus:bg-white"
                  placeholder="Enter your password"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#6B4F4E] transition-colors duration-200 p-1 rounded-lg hover:bg-gray-100"
                >
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center group">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-[#6B4F4E] focus:ring-[#6B4F4E] border-gray-300 rounded transition-all duration-200"
                />
              ...
              <div className="text-sm">
                <Link to="/forgot-password" className="text-[#6B4F4E] hover:text-[#5a3f6b] font-semibold transition-colors duration-200 relative group">
                  Forgot password?
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-[#6B4F4E] to-[#8B6B9A] text-white py-3.5 px-6 rounded-xl font-semibold hover:from-[#5a3f6b] hover:to-[#6B4F4E] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#6B4F4E] focus:ring-offset-2 shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] group relative overflow-hidden"
            >
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/signup" className="text-[#6B4F4E] hover:text-[#5a3f6b] font-semibold transition-colors duration-200 relative group">
                Create account
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#6B4F4E] transition-all duration-300 group-hover:w-full"></span>
              </Link>
            </p>
