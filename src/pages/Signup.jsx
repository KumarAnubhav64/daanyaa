  ...
  const passwordRequirements = [
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center px-4 py-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-10 left-20 w-80 h-80 bg-gradient-to-r from-[#715482]/20 to-purple-400/20 rounded-full blur-3xl animate-pulse"></div>
        ...
        {/* Floating particles */}
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-[#715482]/30 rounded-full animate-float"></div>
      ...
      <div className="max-w-md w-full space-y-8 relative z-10 animate-fade-in-up">
        <div className="text-center">
          ...
          {/* <div className="flex items-center justify-center gap-6 mt-4 text-xs text-gray-500">
            ...
            <div className="flex items-center gap-1">
              <Award size={12} className="text-[#715482]" />
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/50 p-8 transition-all duration-500 hover:shadow-3xl hover:bg-white/90 animate-slide-up relative">
          ...
          <form className="mt-7 space-y-5" onSubmit={handleSubmit}>
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2 group">
                <label htmlFor="firstName" className="block text-sm font-semibold text-gray-700 group-focus-within:text-[#715482] transition-colors duration-200">
                  First name
                </label>
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#715482]/20 focus:border-[#715482] outline-none transition-all duration-300 text-gray-900 placeholder-gray-400 hover:border-gray-300 bg-gray-50/50 focus:bg-white"
                    placeholder="John"
                  />
              ...
              <div className="space-y-2 group">
                <label htmlFor="lastName" className="block text-sm font-semibold text-gray-700 group-focus-within:text-[#715482] transition-colors duration-200">
                  Last name
                </label>
                <div className="relative">
                  <input
            ...
            <div className="group">
              <label htmlFor="password" className="block text-sm font-medium text-gray-700 mb-2 group-focus-within:text-[#715482] transition-colors">
                Password
              </label>
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 pr-12 border-2 border-gray-200 rounded-2xl focus:ring-2 focus:ring-[#715482]/50 focus:border-[#715482] outline-none transition-all duration-300 bg-white/80 hover:bg-white hover:border-gray-300"
                  placeholder="Create a strong password"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-[#715482] transition-colors duration-200 p-1 rounded-lg hover:bg-gray-100"
                >
            ...
            <div className="group">
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700 mb-2 group-focus-within:text-[#715482] transition-colors">
                Confirm password
              </label>
              <div className="relative">
                <input
            ...
            <div className="flex items-start p-4 bg-gray-50/80 rounded-xl border border-gray-200/50">
              <input
                ...
                onChange={handleInputChange}
                className="h-4 w-4 text-[#715482] focus:ring-[#715482] border-gray-300 rounded mt-1 transition-colors"
              />
              <label htmlFor="agreeToTerms" className="ml-3 block text-sm text-gray-700 cursor-pointer">
                I agree to the{' '}
                <Link to="/terms" className="text-[#715482] hover:text-[#5a3f6b] font-medium relative group">
                  Terms of Service
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#715482] transition-all duration-300 group-hover:w-full"></span>
                </Link>{' '}
                and{' '}
                <Link to="/privacy" className="text-[#715482] hover:text-[#5a3f6b] font-medium relative group">
                  Privacy Policy
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#715482] transition-all duration-300 group-hover:w-full"></span>
                </Link>
              </label>
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-[#715482] to-[#8B6B9A] text-white py-3.5 px-6 rounded-xl font-semibold hover:from-[#5a3f6b] hover:to-[#715482] transform hover:scale-[1.02] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#715482] focus:ring-offset-2 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none group relative overflow-hidden"
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/login" className="text-[#715482] hover:text-[#5a3f6b] font-medium transition-colors relative group">
                Sign in
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#715482] transition-all duration-300 group-hover:w-full"></span>
              </Link>
            </p>
